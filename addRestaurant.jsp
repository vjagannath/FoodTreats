	...
	<div id="page-wrapper">
		<section style="background-color: #000">
			...
			<header id="header" class="alt" style="background-color: #000">
				<h1>
					<a href="FoodTreatsHome">Food Treats</a>6
				</h1>
				<nav id="nav">
					<ul>
		...
		<section>
			...
			<section class="box">
				<div class="row uniform 50%">
					...
					<div>
						<%
							Object restaurantUpdateMsg = request.getAttribute("RestaurantAddMessage");
						...
						<form action="FoodTreatsRestaurantManagement" method="post">
							<div class="12u">
								<h3>Add Your Restaurant</h3><br /> 
								<input type="text" name="id" id="id" placeholder="ID" required/><br /> 
								<input type="text" name="image" id="image" placeholder="Image" required/><br /> 
								<input type="text" name="restaurant" id="restaurant" placeholder="Name of your Restaurant" required/> <br /> 
								<input type="text" name="location" id="location" placeholder="Location" required/> <br /> 
								<input type="text" name="email" id="email" placeholder="Please Enter your Email-id" required/> <br />
								...
								<p>
									Maximum Occupancy <input type="number" min="10" required>
									&nbsp
								</p>

								<p>
									Meal Type <input type="checkbox" name="serves" value="1" required>Breakfast
								...
								<p>
									Open Days <input type="checkbox" name="opendays" value="1" required/>Monday
								...
								<br /> <input type="submit" name="submitid" value="Add_Restaurant" />
							</div>
						</form>
					</div>
				</div>
