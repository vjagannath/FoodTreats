...
<br/>
			...
			<!-- Main -->
			<div style="align:left; background-color:#fff; height:1000px; width:250px">
														<br/>
														<br/>
														<a href="index.jsp"><h2 style="font-family:Georgia"> Food Treats </h2></a>
														<h4 style="font-family:Comic Sans MS">Filter:</h4>
